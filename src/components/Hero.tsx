            ...
            <section className='px-10 md:px-14 lg:px-32 flex justify-center items-center' >
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center text-white px-4 md:px-0 gap-4 z-10">
                    ...
                    <div className="flex flex-col md:flex-row gap-4 text-base w-full md:w-auto justify-center items-start md:items-center">
                        <button className="bg-black text-white border-gray-600 border-2 py-3 px-6 rounded-lg w-auto flex flex-row justify-between items-center gap-2"><svg className="w-6 h-6" viewBox="0 0 24 24" fill="currentColor">
