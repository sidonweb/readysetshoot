    ...
    return (
        <div className="relative">
            ...
            <section className='h-screen flex flex-col md:flex-row justify-between px-10 md:px-14 lg:px-32' >
                ...
                <div className='z-10 flex flex-col items-start justify-center h-full  text-white px-4 gap-4'>
                    <h1 className='text-4xl md:text-6xl mb-4 text-start md:leading-18 font-[440] '>
                        The Only App <br />
                        You Need To Plan <br />
                    ...
                    <p className='max-w-3xl text-lg mb-6 text-start text-[#F1F1F1]'>
